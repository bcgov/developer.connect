...
> **Who this page is for:** These steps describe onboarding for **API accounts** (vendors or users integrating with BC Registries and Digital Services server-to-server using an API key tied to their own BC Registries account).
>
> If you're building a **partner app** where your end users sign in with BC Registries SSO and your backend calls our APIs with the end user's session, your setup is different (Keycloak client registration for SSO plus an app-level API key). Contact the [Digital Delivery – Partnerships team](https://docs.google.com/forms/d/e/1FAIpQLSe_wKlgPMm9lf1Gdb-TPBzKw1Kki-U57dk1ni1WnHuzAaESsQ/viewform) to get started. For a technical overview of how partner apps authenticate and how payments are routed, see the [APIs Summary](/products/get-started/apis-summary) and the [Pay overview](/products/pay/overview).
